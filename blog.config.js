...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ASONG BLOG', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '前端，现在在学Unity', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://asong.me', // 网站地址
